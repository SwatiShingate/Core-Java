...
public class D02P06_2 {
    ...
    public D02P06_2(String playerName, float critic1) throws NotEligibleException {
    ...
    public D02P06_2(String playerName, float critic1, float critic2, float critic3) throws NotEligibleException {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            D02P06_2 player1 = new D02P06_2("John", 9.3f, 9.67f, 8.7f);
 
            player1.display();
 
 
            D02P06_2 player2 = new D02P06_2 ("Henry", 1.5f);
